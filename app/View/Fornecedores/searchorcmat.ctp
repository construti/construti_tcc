		...
		<div id="camposlacunas"> <!-- div com os campos a serem preenchidos -->
			...
			<div class="campos">
				<select name="tipo" class="intexto"/>
					...
					<option value="modified">Data da Última Modificação</option>
				</select>
			</div>
		</div>
...
<div id="resultados"> <!-- resultados da pesquisa -->
	...
	<table class="tabela">
		...
		<tr>
			...
			<td align="center">
				<?php echo $this->Html->link('atualizar', array('action' => 'atprecosmat', $result['Orcamento_materiais']['orcamentos_materiais_id'])); ?>
			</td>
		</tr>
		<?php endforeach; } ?>
	</table>
