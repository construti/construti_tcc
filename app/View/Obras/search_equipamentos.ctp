...
<div id="formulariotopo"> <!-- topo do formulário -->
	<div id="tituloform">Pesquisa de Obras para Alocação de Equipamentos</div> <!-- título do formulário -->
</div>
...
<div id="resultados"> <!-- resultados da pesquisa -->
	...
	<table class="tabela">
		...
		<tr>
			...
			<td align="center">
				<?php echo $this->Html->link('alocar/desalocar', array('action' => 'des_alocar_equipamentos', $result['Obra']['obra_id'])); ?>
			</td>
		</tr>
		<?php endforeach; } ?>
	</table>
