...
<div id="formulariocorpo"> <!-- corpo do formulário -->
	<?php echo $this->Form->create('Obra'); ?> <!-- início do formulário -->
		...
		<div id="camposlacunasE"> <!-- div com os campos da esquerda a serem preenchidos -->
			...
			<br/>
			<?php echo $this->Form->input('terreno_id', array('label' => '', 'id' => 'terreno_id', 'class' => array('intexto'))); ?>
			<br/>
			<?php echo $this->Form->input('projeto_id', array('label' => '', 'id' => 'projeto_id', 'class' => array('intexto'))); ?>
			<br/>
			<?php echo $this->Form->input('material_obra_id', array('label' => '', 'id' => 'material_obra_id', 'class' => array('intexto'))); ?>
