...
<div id="orcamento"> <!-- resultados da pesquisa -->
	...
	<table class="tabela">
		...
		<tr>
			...
			<td align="right"><?php echo number_format($p['Previsao_projeto']['custo'],2,",","."); ?></td>
		</tr>
		<?php $tproj += $p['Previsao_projeto']['custo']; ?>
		<?php endforeach; ?>
		<tr>
			<td id="tproj">Total Projetos</td>
			<td style="text-align:right; border-top: solid 1px #aaa; font-weight: bold;"><?php echo number_format($tproj,2,",","."); ?></td>
		</tr>
	</table>
	...
	<table class="tabela">
		...
		<tr>
			...
			<td align="right"><?php $submao = $f['Previsao_funcionario']['salario'] * $f['Previsao_funcionario']['qtd_horas'];
		...
		<tr>
			...
			<td colspan="4" style="text-align:right; border-top: solid 1px #aaa; font-weight: bold;"><?php echo number_format($tmaoobra,2,",","."); ?></td>
		</tr>
	</table>
	...
	<table class="tabela">
		...
		<tr>
			...
			<td align="right"><?php $subequip = $e['Previsao_equipamento']['qtd'] * $e['Previsao_equipamento']['qtd_horas'] * $e['Previsao_equipamento']['valor_hora']; 
		...
		<tr>
			...
			<td colspan="4" style="text-align:right; border-top: solid 1px #aaa; font-weight: bold;"><?php echo number_format($tequip,2,",","."); ?></td>
		</tr>
	</table>
	...
	<table class="tabela">
		...
		<tr>
			...
			<td align="right"><?php $submat = $m['Previsao_material']['qtd'] * $m['Previsao_material']['custo']; 
	...
	<table class="tabela">
		...
		<tr>
			...
			<td align="right"><?php echo number_format($lt['Previsao_taxa']['custo'],2,",","."); ?></td>
		</tr>
